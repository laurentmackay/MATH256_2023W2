...
\twomini[.6]{.35}{.65}{\includegraphics[width=.8\columnwidth]{images/spring_dashpot.pdf}}{\vfill
...
\slide[Spring oscillators with periodic forcing: $f(t)=F_0\cos(\omega t)$]{\vfill
\centerline{\includegraphics{images/spring_dashpot_forced.pdf}}
\vfill}

\slide[Harmonic motion with forcing]{\vspace{-1.5em}
\[\underset{\student{\underbrace{\hphantom{x\pp+\omega_0^2 x}}_{\frac1m (mx''+kx) \text{ with } \omega_0=\sqrt{k/m}}}}{x\pp+\omega_0^2 x}  =\frac{f(t)}{m}= \frac{F_0}{m}\cos (\omega t)\hspace{2em}\text{with}\qquad\larray{\omega\neq\omega_0\\x(0)=x\p(0)=0}\]
...
\algn{\uline{\sin(t):}\;\;-\omega^2B+\omega_0^2B &= 0 &\Rightarrow B=&0\\
\uline{\cos(t):}\;\;-\omega^2A+\omega_0^2A &= \frac{F_0}{m} &\Rightarrow A=&\frac{F_0}{m\left(\omega_0^2-\omega^2 \right)}\\
...
%
%$x_h= c_1 \cos (\omega_0 t)  +c_2 \sin (\omega_0 t)$ \hspace{2em} $x_p=?$\student{\algn{x_p&\neq A \cos (\omega_0 t)  + B \sin (\omega_0 t)\\x_p&=A t\cos (\omega_0 t)  + Bt \sin (\omega_0 t) \\
%x_p' &= A\cos(\omega_0t) - \omega_0At\sin(\omega_0t)+  B\sin(\omega_0t) + \omega_0Bt\cos(\omega_0t) \\
%x_p'' &= -\omega_0 A\sin(\omega_0t) - \omega_0A(\sin(\omega_0t)+\omega_0t\cos(\omega_0t)) \\&\phantom{=}+ \omega_0B\cos(\omega_0t) + \omega_0B(\cos(\omega_0t)-\omega_0t\sin(\omega_0t))\\
%&=-\omega _0 \left(t \omega _0 \left(A \cos \left(t \omega _0\right)+B \sin \left(t \omega _0\right)\right)+2 A \sin \left(t \omega _0\right)-2 B \cos \left(t \omega _0\right)\right)}}
%
%}
%\end{comment}
...
$x_h= c_1 \cos (\omega_0 t)  +c_2 \sin (\omega_0 t)$ \hspace{2em} $x_p=?$\student{\algn{y_p&\neq A \cos (\omega_0 t)  + B \sin (\omega_0 t) & \text{(mathematical} &\text{ resonance)}\\ y_p&= \cancelto{0}{A} t\cos (\omega_0 t)  + Bt \sin (\omega_0 t) & B=&\frac{F_0}{2m\omega_0} }}
...
\slide[Damped oscillator with forcing]{\vspace{-1.5em}
...
\end{cases}\]\vfill
\student{Since $\beta>0$, all exponents are negative\\\centerline{$\Rightarrow \quad x_h \to 0$ as $t\to\infty$ }}
}


\slide[Damped oscillator with forcing]{\vspace{-1.5em}
\[mx\pp+\beta x\p+kx=F_0\cos(\omega t)\]
$x(t)=x_h(t)+x_p(t)$\vfill
Three cases:
\[x_{h}(t)=\begin{cases}
e^{-\frac{\beta}{2m}t}\left(c_{1}\cos\left(\omega_{1}t\right)+c_{2}\sin\left(\omega_{1}t\right)\right) & \beta^{2}<4km\\
c_{1}e^{r_{1}t}+c_{2}e^{r_{2}t} & \beta^{2}>4km\\
...
\[x_p = A \cos (\omega t)+B \sin (\omega t) \qquad \forall \; \omega\in \mathbb{R}\]\vfill
\student{\centerline{Impossible to have mathematical resonance with periodic forcing} }
\vfill
...
\draw[|-|] (0.1,-1.125) -- (6,-1.125) node[midway, below]{transient response ($x_h+x_p$)};
\draw[|->] (6.1,-1.125) -- (11,-1.125) node[midway, below]{steady state response ($x_p$)};
}
...
\ucover{
\tikzplot[\xcoord{1.41244}{ \omega_{\rm max} }]{.1}{6}{.1}{4}{\omega}{}{
...
\tikzplot[\xcoord{1.105}{} \xcoord{1.05}{\omega_{\rm max}}]{.1}{4}{.1}{2.5}{\omega}{}{
\draw[domain=0:4, samples=400, smooth,  black, thick] plot (\x, { 10/sqrt(64-80*\x*\x+36*\x*\x*\x*\x)  });
\draw[black, dashed] (1.05,0) -- (1.05,2.26134);
\draw  (1.4, 0.15) node{$\omega_1$};
}
\[\omega_{\rm max} = \sqrt{ \frac{k}{m}- \frac12\paren{\frac{\beta}{m}} ^2} \approx \omega_1\]
}{Overdamped:
\[x_h = c_1e^{r_1t} + c_2e^{r_2t}\]
$r_{1,2} = \frac{-\beta \pm \sqrt{\beta^2 -4km}}{2m}$

\tikzplot[ \xcoord{0}{\omega_{\rm max}}]{.1}{4}{.1}{2.5}{\omega}{}{
...
\[mx\pp+\beta x\p+ kx= F_0 \cos(\omega t)\]
What happens as $\omega \to \omega_{\rm max}$?

\vfill
\student{
\itmz{
\item  Transient response ($x_h+x_p$ for $t\approx0$) \subitem{amplitude and duration both grow larger}
\item Steady state response ($x_p$)  \subitem{amplitude grows larger}
}\vfill
\centerline{This phenomenon is called quasi-resonance or practical resonance.}\vfill
\centerline{$\omega_{\rm max}$ is called the quasi-resonance frequency}
}
\vfill
}
