...
\slide[Amplitude vs Forcing Frequency]{\vspace{-.65em}
How does the amplitude of the steady state response vary with $\omega$?\vfill
\twomini[.9]{0.55}{0.45}{
\uline{Underdamped:}
...
\student{
\draw (1.05,1.4) circle [x radius=0.5cm, y radius=1cm];

\draw (2.7, 2.2) node{\footnotesize Pseudo-Resonance};
}
}
\vspace{-1.25em}
