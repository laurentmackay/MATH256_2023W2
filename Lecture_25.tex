...
\vfill
\ex{$u_0(x)= u\paren{x-\frac{L}{4}} -u\paren{x-\frac{3L}{4}}$}\vfill
\twomini[.7]{.5}{.5}{
 \uline{$u(0,t)=u(L,t)=0$}: \vfill
\centerline{\includegraphics[width=0.9\columnwidth]{images/clamped_BCs_heaviside.pdf}}
}{
 \uline{$u_x(0,t)=u_x(L,t)=0$}: \vfill
\centerline{\includegraphics[width=0.9\columnwidth]{images/zero_flux_BCs_heaviside.pdf}}}
}
...
\vfill
\twomini[.7]{.45}{.55}{
\centerline{\includegraphics[width=\columnwidth]{images/clamped_BCs_heaviside.pdf}}
}{
\student{
...
\centerline{\includegraphics[width=12cm]{images/clamped_BCs_long_term.pdf}}\vfill
\uline{$u_x(0,t)=u_x(L,t)=0$}: $u(x,t) \approx \frac{a_0}{2} + e^{-\alpha\frac{\pi^2}{L^2}t}a_1\cos\paren{\frac{\pi}{L}x} $ \vfill 
\centerline{\includegraphics[width=7cm]{images/zero_flux_BCs_long_term.pdf}}
